...
to explore the datasets and discuss our goals before starting the analysis. With a better 
understanding of each dataset and how they relate to one another, it would be much easier 
to understand why we are importing specific files, selecting certain ranges, or arranging the 
data in a particular way. Overall, I am happy that I am now able to perform basic data analysis 
whenever I have a dataset to work with.😃
